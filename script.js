...
const flexGroups = document.querySelectorAll('.flex_group');//if we use just querySelector then we use 1st el
...
}//here we just state the function, which will be called later
